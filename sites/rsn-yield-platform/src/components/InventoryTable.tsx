      ...
      {totalPages > 1 && (
        <div className="flex items-center justify-end gap-2 text-xs">
          <button
            ...
            className="rounded-md border border-[#E5E7EB] bg-white px-3 py-1 text-slate-700 transition-colors hover:border-[#1F3A5F] disabled:opacity-40 disabled:hover:border-[#E5E7EB]"
          >
            Prev
          </button>
